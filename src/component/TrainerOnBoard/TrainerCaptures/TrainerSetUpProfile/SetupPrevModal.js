                            ...
                            <div className="profile_wrapper_container ">
                                <div className="profile_header">
                                    <div className="inner_profile container">
                                        <img
                                            src={
                                                trainerdetailData.profilePicture
                                            }
                                            alt="Image not Added"
                                        />
                                        ...
                                        <div className="profile_aside_items">
                                            <div className="profile_aside_item">
                                                ...
                                                <div className="profile_aside_inner_item">
                                                    ...
                                                    <h6>
                                                        {`$
                              ${trainerdetailData.oneOnOnePricing.inPersonAtTrainerLocation}`}
                                                        <span>
                                                            (In Person Session)
                                                        </span>
                                                    </h6>
                                                ...
                                                <div className="profile_aside_inner_item">
                                                    {/* {trainerdetailData.socialSessionPricing &&
                                                        trainerdetailData
                                                            ...
                                                            .inPeronAtTrainerLocationfor2People ? ( */}
                                                    <h6>
                                                        {`$${trainerdetailData.socialSessionPricing.inPeronAtTrainerLocationfor2People}`}
                                                        <span>
                                                            / Session (For 2
                                                            People)
                                                        </span>
                                                    ...
                                                    {/* {trainerdetailData.socialSessionPricing &&
                                                        trainerdetailData
                                                            ...
                                                            .inPeronAtTrainerLocationfor3People ? ( */}
                                                    <h6>
                                                        {`$${trainerdetailData.socialSessionPricing.inPeronAtTrainerLocationfor3People}`}
                                                        <span>
                                                            / Session (For 3
                                                            People)
                                                        </span>
                                                    ...
                                                    {/* {trainerdetailData.socialSessionPricing &&
                                                        trainerdetailData
                                                            ...
                                                            .inPeronAtTrainerLocationfor4People ? ( */}
                                                    <h6>
                                                        {`$${trainerdetailData.socialSessionPricing.inPeronAtTrainerLocationfor4People}`}
                                                        <span>
                                                            / Session (For 4
                                                            People)
                                                        </span>
                                            ...
                                            <div className="profile_aside_item">
                                                ...
                                                <hr />
                                                <div className="profile_aside_inner_item">
                                                    {trainerdetailData.currentExperience &&
                                                    trainerdetailData
                                                        .currentExperience
                                                        .workLocation ? (
