        ...
        <div className="inner_setup_container">
          ...
          <div className="certificate_content">
            ...
            {trainerSetupData.certificateFields.map((field, id) => {
              return (
                <div key={`${field}-${id}`} className="certificate_fields">
                  <input
                    placeholder="Certification Title"
                    name="certificate"
                    value={field.certificate}
                    onChange={(event) =>
                      handleChangeCertificateInput(id, event)
                    }
                  />
                  <input
            ...
            <button
              onClick={() => {
                ...
                let payload = { 
                    ...
                    trainingProcess: TrainerSetupPayload.training_process,
                    certification: TrainerSetupPayload.certificateFields,
                    virtualMeetingLink: TrainerSetupPayload.zoom_link,
                    trainingFacility: TrainerSetupPayload.haveAFacility,
                    willingToTravel: TrainerSetupPayload.willingToTravel,
                    servicableLocation: TrainerSetupPayload.facility_details,
                    instagramProfile: TrainerSetupPayload.instagram,
                    websiteLink: TrainerSetupPayload.website,
                    firstName: TrainerCardPayload.firstName,
                    lastName: TrainerCardPayload.lastName,
                    areaOfExpertise: TrainerCardPayload.verticals,
                    description: TrainerCardPayload.shortDescription,
                    oneOnOnePricing: {
                        inPersonAtClientLocation :TrainerCardPayload.inPersonAtClient_individualCharge,
                        inPersonAtTrainerLocation: TrainerCardPayload.inPersonAtTrainer_individualCharge,
                        virtualSession:TrainerCardPayload.virtual_individualCharge,
                        passRatefor3SessionAtClientLocation: TrainerCardPayload.inPersonAtClient_threeSessionRate,
                        passRatefor10SessionAtClientLocation: TrainerCardPayload.inPersonAtClient_tenSessionRate,
                        passRatefor3SessionAtTrainerLocation: TrainerCardPayload.inPersonAtTrainer_threeSessionRate,
                        passRatefor10SessionAtTrainerLocation: TrainerCardPayload.inPersonAtTrainer_tenSessionRate,
                        passRatefor3SessionAtVirtual: TrainerCardPayload.virtual_threeSessionRate,
                        passRatefor10SessionAtVirtual: TrainerCardPayload.virtual_tenSessionRate,
                    },
                        socialSessionPricing: {
                        inPeronAtClientLocationfor2People:TrainerCardPayload.inPersonAtClient_twoPPL,
                        inPeronAtClientLocationfor3People:TrainerCardPayload.inPersonAtClient_threePPL,
                        inPeronAtClientLocationfor4People:TrainerCardPayload.inPersonAtClient_fourPPL,
                        inPeronAtTrainerLocationfor2People:TrainerCardPayload.inPersonAtTrainer_twoPPL,
                        inPeronAtTrainerLocationfor3People:TrainerCardPayload.inPersonAtTrainer_threePPL,
                        inPeronAtTrainerLocationfor4People:TrainerCardPayload.inPersonAtTrainer_fourPPL,
                        virtualSessionfor2People:TrainerCardPayload.virtual_twoPPL,
                        virtualSessionfor3People:TrainerCardPayload.virtual_threePPL,
                        virtualSessionfor4People:TrainerCardPayload.virtual_fourPPL,
                    },
                        classSessionPricing: {
                        inPersonAtclientLocationfor15People:TrainerCardPayload.inPersonAtClient_classFlatRate,
                        inPersonAttrainerLocationfor15People:TrainerCardPayload.inPersonAtTrainer_classFlatRate,
                        // virtualAtclientLocationfor15People:TrainerCardPayload,
                        // virtualAttrainerLocationfor15People:TrainerCardPayload,
                        virtualSessionfor15People:TrainerCardPayload.virtual_classFlatRate,
                    }
