      ...
      if (data) {
        ...
        retrievedObject === null
          ...
          : setTrainerData({
            ...
            classFlatRate: `${retrievedObject.classFlatRate || 'NA'}`,
            classFlatRateTl: `${retrievedObject.classFlatRateTl || 'NA'}`,
            classFlatRateVt: `${retrievedObject.classFlatRateVt || 'NA'}`,

            individualCharge: `${retrievedObject.individualCharge || 'NA'}`,
            individualChargeTl: `${retrievedObject.individualChargeTl || 'NA'}`,
            individualChargeVt: `${retrievedObject.individualChargeVt || 'NA'}`,

            ssFourPeopleCharge: `${retrievedObject.ssFourPeopleCharge || 'NA'}`,
            ssFourPeopleChargeTl: `${retrievedObject.ssFourPeopleChargeTl || 'NA'}`,
            ssFourPeopleChargeVt: `${retrievedObject.ssFourPeopleChargeVt || 'NA'}`,
            ssThreePeopleCharge: `${retrievedObject.ssThreePeopleCharge || 'NA'}`,
            ssThreePeopleChargeTl: `${retrievedObject.ssThreePeopleChargeTl || 'NA'}`,
            ssThreePeopleChargeVt: `${retrievedObject.ssThreePeopleChargeVt || 'NA'}`,
            ssTwoPeopleCharge: `${retrievedObject.ssTwoPeopleCharge || 'NA'}`,
            ssTwoPeopleChargeTl: `${retrievedObject.ssTwoPeopleChargeTl || 'NA'}`,
            ssTwoPeopleChargeVt: `${retrievedObject.ssTwoPeopleChargeVt || 'NA'}`,
            tenSessionRate: `${retrievedObject.tenSessionRate || 'NA'}`,
            tenSessionRateTl: `${retrievedObject.tenSessionRateTl || 'NA'}`,
            tenSessionRateVt: `${retrievedObject.tenSessionRateVt || 'NA'}`,
            threeSessionRate: `${retrievedObject.threeSessionRate || 'NA'}`,
            threeSessionRateTl: `${retrievedObject.threeSessionRateTl || 'NA'}`,
            threeSessionRateVt: `${retrievedObject.threeSessionRateVt || 'NA'}`,
          });
...
function Accordion({ title, children }) {
  ...
  return (
    <div className="accordion-wrapper">
      ...
      <div
        className={`accordion-item ${!isOpenAccodion ? "collapsed" : ""
          }`}
      >
