...
//       <div className="text_rgt">
//         <div className="lft">How it Works</div>
//         <div className="center">who we are</div>
//         <div className="rght">who we are</div>
//       </div>
//       <div className="Logo">
//         <h1> Logo</h1>
//         <span> Do what moves you</span>
//       </div>
//     </div>
//   );
// };
        ...
        <div className="navbar-container">
          <div className="header-links">
            ...
            >
              ...
              <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Blue_Line)">
                <line
                  id="Blue_Line-2"
                  data-name="Blue Line"
                  y2="18"
          ...
          <div className="search-items">
            <div className="input-item">
              <input type="text" placeholder="Rotating prompts go here"></input>
