  ...
  render() {
    return (
      <>
          ...
          <div className="background_container ">
            ...
            <div className="container_trainer ">
              ...
              <div className="answer">
                Get access & matched with the right clients based on your
                expertise. Maximize your time and earnings by booking 1-on-1 or
                group workouts. Minimize customer acquisition cost with no
        ...
        <div className="mobile-layout-trainerInfo">
          ...
          <div >
            <Link to="/trainer/signup" className="button">
              APPLY AS A TRAINER <BlueHoverButton />
            </Link>
          </div>
        </div>
