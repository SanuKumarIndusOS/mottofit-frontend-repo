    ...
    React.useEffect(() => {
        ...
        fetch(
                ...
                "&startDate=2021-05-01&endDate=2021-05-08&timeBlock=EarlyBird",
            {
                ...
                headers: {
                    Authorization:
                        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImFlOTBkYmIzLTNmY2EtNGNmYy04ZDA0LWZiYjUzNzVmZjBjMiIsImlhdCI6MTYyMDExMzQ4NywiZXhwIjoxNjIwMTIwNjg3fQ.1QgdcJvv9T-3fAXCw0swtKQ4JPZLcOwv9zmHeJATq48",
                },
            }
        )
