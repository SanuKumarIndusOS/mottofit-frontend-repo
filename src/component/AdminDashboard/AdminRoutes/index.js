...
import { SideBarRouteDataAdmin } from "./MottoAdminSidebar/SideBarRouteDataAdmin";
import SubMenuAdmin from "./MottoAdminSidebar/SubMenuAdmin";
            ...
            <div className="admin_container_trainer">
                <div className="admin_sidenav">
                    ...
                    <div className="admin_sidenav_links">
                        {SideBarRouteDataAdmin.map((item, index) => {
                            return <SubMenuAdmin item={item} key={index} />;
                        })}
                    </div>
