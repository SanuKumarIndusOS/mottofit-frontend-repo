...
import "./styles.scss";
import ScheduleIcon from "../../../assets/TrainerDashboard/SideBarAssets/Shedule Icon.svg";
...
import MyEarningIcon from "../../../assets/TrainerDashboard/SideBarAssets/My Earnings Icon.svg";
                ...
                <div className="admin_container">
                    <div className="admin_sidenav">
                        ...
                        <div className="admin_sidenav_links">
                            <Link
                                ...
                                className="nav_item"
                            >
                                <img src={ScheduleIcon} alt="icon" /> MY
                                SCHEDULE
                            </Link>
                            <Link
                                to="/trainer-dashboard/session"
                                className="nav_item"
                            >
                                <img src={SessionIcon} alt="icon" /> MY SESSION
                            </Link>
                            <Link
                                to="/trainer-dashboard/message"
                                className="nav_item"
                            >
                                <img src={MessageIcon} alt="icon" /> MESSAGES
                            </Link>
                            <Link to="/marketing" className="nav_item">
                                <img src={MyEarningIcon} alt="icon" /> MY
                                EARNINGS
                            </Link>
                            <Link to="/marketing" className="nav_item">
                    ...
                    <div className="admin_content">
                        ...
                        <div className="admin_content">
                            <Switch>
                                <Route
                                   exact path="/trainer-dashboard/schedule"
                                    component={TrainerSchedule}
                                />
                                <Route
                                   exact path="/trainer-dashboard/session"
                                    component={TrainerSession}
                                />
                                <Route
                                  exact  path="/trainer-dashboard/message"
